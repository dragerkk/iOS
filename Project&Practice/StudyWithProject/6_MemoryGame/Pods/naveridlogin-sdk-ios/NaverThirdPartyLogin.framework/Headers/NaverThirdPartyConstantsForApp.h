...
#define kServiceAppUrlScheme    @"com.kang.--MemoryGame"

#define kConsumerKey            @"LpTodIJzZDL1y2sISUNX"
#define kConsumerSecret         @"WmldIZ70os"
#define kServiceAppName         @"MemoryGame"
